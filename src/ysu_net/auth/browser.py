...
def summarize_account_payload(payload: Any) -> dict:
    """
    兼容两种 account 返回结构：
    1) payload.data.data.accountInfo = [...]
    2) payload.data.accountInfo = [...]

    返回：
      {
        name, service,
        items_map: {title: {content, link}},
      }
    """
